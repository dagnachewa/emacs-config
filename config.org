...
(cc +lsp :variables c-c++-backend 'lsp-ccls)                         ; C/C++/Obj-C madness
...
(use-package! calibredb
  :commands calibredb
  :config
  (setq calibredb-root-dir "/mnt/goyaves-homes-livres"
...
(use-package erc
    ...
    (defun my/erc-start-or-switch ()
      ...
      (if (get-buffer "irc.libera.chat:6697")
        ...
        (erc-tls :server "irc.libera.chat" :port 6697 :nick "perrierjouet")))
    ...
    :custom
    (erc-autojoin-mode 1)
    (erc-autojoin-channels-alist '(("#emacs" "#org-mode" "#archlinux" "#archlinux-fr" "##webdev" "#freebsd" "##linux"
                                    "#nixers_net" "##c" "#c++" "#cplusplus.com" "#postgresql" "#R"
                                    "#scala" "##lisp" "#lispcafe" "#clojure" "#haskell" "#erlang"
                                    "##java" "##javascript" "#python" "#go-nuts" "#lobsters"
                                    "##networking" "#cisco" "#pfsense" "#docker" "#lxcontainers"
                                    "#zsh" "#git" "#Node.js" "#reddit-sysadmin" "#drools"
                                    "#jbpm" "#optaplanner")))
...
**** Tweaking defaults
#+begin_src emacs-lisp
(setq org-directory "/www/Dropbox/Org"                      ; let's put files here
...
#+begin_src emacs-lisp :noweb-ref none :tangle (if (file-exists-p "/www/Dropbox/Org/roam/") "no" "packages.el")
(package! org-roam :disable t)
#+end_src
md-roam
#+begin_src emacs-lisp :tangle yes
(add-to-list 'load-path "~/.config/doom/lisp/md-roam/")
...
(after! org
  ...
  (defvar org-music-beets-db "~/.config/mpd/library.db"
    "Location of the beets DB, for when using beets as the `org-music-track-search-method'")
  (defvar org-music-folder "/mnt/goyaves-home-music/"
...
(defun my-sql-connect (product connection)
    (require my-password "~/.config/doom/lisp/postgresql-password.el.gpg")
...
(use-package easy-hugo
 :init
 (setq easy-hugo-basedir "/www/Dropbox/Org/www/")
 (setq easy-hugo-url "https://dagnachewa@github.io")
 (setq easy-hugo-sshdomain "blogdomain")
 (setq easy-hugo-root "www/Dropbox/Org/www/")
